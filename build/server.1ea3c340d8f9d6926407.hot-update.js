...
function CrewCard(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    style: {
      backgroundImage: isHover ? "url(".concat(__webpack_require__("./src/components/cards sync recursive ^.*$")("".concat(baseURL, "/image/").concat(photos[0])), ")") : "url(".concat(__webpack_require__(/*! assets/images/member-img-0.png */ "./src/assets/images/member-img-0.png"), ")")
    },
    onClick: cardToggle,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=server.1ea3c340d8f9d6926407.hot-update.js.map