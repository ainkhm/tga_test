...
function CrewCard(_ref) {
  ...
  console.log('sdf', firstPhoto, secondPhoto);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    style: {
      backgroundImage: isHover ? "url(".concat(firstPhoto, ")") : "url(".concat(__webpack_require__("./src/components/cards sync recursive ^.*$")("".concat(test, "/image/").concat(photos && photos[1])), ")")
    },
    onClick: cardToggle,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=server.d161095127167a30e770.hot-update.js.map