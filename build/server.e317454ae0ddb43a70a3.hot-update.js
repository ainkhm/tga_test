...
function Team() {
  ...
  var test = payload && payload.reduce(function (result, item) {
    if (item.slug !== 'paul_chudleigh' || 'michael_sastry') {
      return _objectSpread(_objectSpread({}, result), {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()({}, item.name, item.value));
    }
  });
...
//# sourceMappingURL=server.e317454ae0ddb43a70a3.hot-update.js.map