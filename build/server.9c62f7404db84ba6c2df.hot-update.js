...
function CrewCard(_ref) {
  ...
  console.log('sdf', "".concat(test, "/image/").concat(photos && photos[0]));
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    style: {
      backgroundImage: isHover ? "url(".concat(__webpack_require__("./src/components/cards sync recursive ^.*$")("".concat(test && test, "/image/").concat(photos && photos[0])), ")") : "url(".concat(__webpack_require__("./src/components/cards sync recursive ^.*$")("".concat(test && test, "/image/").concat(photos && photos[1])), ")")
    },
    onClick: cardToggle,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=server.9c62f7404db84ba6c2df.hot-update.js.map