...
var HomeInfo = function HomeInfo(initialState, action) {
  switch (action.type) {
    case _types__WEBPACK_IMPORTED_MODULE_2__["FETCH_HOME_INFO"]:
      return _objectSpread(_objectSpread({}, state), {}, {
        isFetching: true
      });

    case _types__WEBPACK_IMPORTED_MODULE_2__["FINISHED_FETCH_HOME_INFO"]:
      return {
        isFetching: false,
        payload: [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(state), [action.data])
      };

    case _types__WEBPACK_IMPORTED_MODULE_2__["ERROR_FETCH_HOME_INFO"]:
      return _objectSpread(_objectSpread({}, state), {}, {
        payload: [],
        isFetching: false,
        error: action.error
...
//# sourceMappingURL=server.0949bbcd5c20face02c1.hot-update.js.map