...
function CrewCard(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    style: {
      backgroundImage: isHover ? "url(".concat(__webpack_require__("./src/components/cards sync recursive ^.*$")("".concat(test, "/image/").concat(photos[0])), ")") : "url(".concat(__webpack_require__("./src/components/cards sync recursive ^.*$")("".concat(baseURL, "/image/").concat(photos[1])), ")")
    },
    onClick: cardToggle,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=server.07d40cf4eb2557c7c898.hot-update.js.map