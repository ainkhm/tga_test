...
/*!******************************!*\
  !*** ./src/reducers/team.js ***!
  \******************************/
/*! exports provided: TeamList, TeamAll, TeamMember */
...
var TeamAll = function TeamAll() {
  ...
  switch (action.type) {
    case [_types__WEBPACK_IMPORTED_MODULE_1__["FETCH_TEAM_ALL"], _types__WEBPACK_IMPORTED_MODULE_1__["FETCH_TEAM_COUNT"]]:
      return _objectSpread(_objectSpread({}, state), {}, {
        isFetching: true
      });

    case [_types__WEBPACK_IMPORTED_MODULE_1__["FINISHED_FETCH_TEAM_ALL"], _types__WEBPACK_IMPORTED_MODULE_1__["FINISHED_C"].FETCH_TEAM_COUNT]:
      return _objectSpread(_objectSpread({}, state), {}, {
        isFetching: false,
        payload: action.data
      });

    case [_types__WEBPACK_IMPORTED_MODULE_1__["ERROR_FETCH_TEAM_ALL"], _types__WEBPACK_IMPORTED_MODULE_1__["ERROR_FETCH_TEAM_COUNT"]]:
      return _objectSpread(_objectSpread({}, state), {}, {
        payload: [],
        isFetching: false,
        error: action.error
...
//# sourceMappingURL=server.9e9f2b7e372701f6ec79.hot-update.js.map