...
var map = {
	...
	"./diamond-icon.svg": "./src/assets/icons/diamond-icon.svg",
	"./facebook-icon.svg": "./src/assets/icons/facebook-icon.svg",
	"./linkedin-icon.svg": "./src/assets/icons/linkedin-icon.svg",
	"./shield-icon.svg": "./src/assets/icons/shield-icon.svg",
	"./tga-icon.svg": "./src/assets/icons/tga-icon.svg",
	"./vision-icon.svg": "./src/assets/icons/vision-icon.svg"
};
...
//# sourceMappingURL=server.cf7d5a8aa183e7497a25.hot-update.js.map