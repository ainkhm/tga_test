...
function OurVision(props) {
  ...
  var _useSelector = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["useSelector"])(function (state) {
    return state.AboutInfo;
      ...
      payload = _useSelector.payload; // const goalItems = [
  // 	{
  // 		title: 'Most valuable thing',
  // 		description:
  // 			'There is as little hierarchy as possible and the most valuable thing is the quality of the work or the idea - not the position or years of experience one has',
  // 		src: require('assets/icons/valuable-icon.svg'),
  // 	},
  // 	{
  // 		title: 'What we care',
  // 		description:
  // 			'We care about and take responsibility for the work we do, with high standards of quality',
  // 		src: require('assets/icons/diamond-icon.svg'),
  // 	},
  // 	{
  // 		title: 'Become better',
  // 		description:
  // 			'We always learn and improve our skills to become better and take greater challenge',
  // 		src: require('assets/icons/degree-icon.svg'),
  // 	},
  // 	{
  // 		title: 'Everyone will be safe',
  // 		description:
  // 			'We want everyone to feel they can fail and be safe because if you are scared to fail you don’t try new things or take risk or new responsibilities - so you don’t get better',
  // 		src: require('assets/icons/shield-icon.svg'),
  // 	},
  // ];
...
//# sourceMappingURL=server.5de1a5c3a1a84d351411.hot-update.js.map