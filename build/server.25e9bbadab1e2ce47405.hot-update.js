...
function CrewCard(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    style: {
      backgroundImage: isHover ? "url(".concat(__webpack_require__("./src/components/cards sync recursive ^.*\\/image\\/$")("".concat(baseURL, "/image/")), ")") : "url(".concat(__webpack_require__("./src/components/cards sync recursive ^.*\\/image\\/\\}$")("".concat(baseURL, "/image/}")), ")")
    },
    onClick: cardToggle,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=server.25e9bbadab1e2ce47405.hot-update.js.map