...
/***/ "./src/components/cards sync recursive ^.*\\/image\\/$":
/*!*************************************************!*\
  !*** ./src/components/cards sync ^.*\/image\/$ ***!
  \*************************************************/
...
webpackEmptyContext.id = "./src/components/cards sync recursive ^.*\\/image\\/$";
...
function CrewCard(_ref) {
  ...
  var test = api__WEBPACK_IMPORTED_MODULE_6__["baseURL"];
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    style: {
      backgroundImage: isHover ? "url(".concat(__webpack_require__("./src/components/cards sync recursive ^.*\\/image\\/$")("".concat(test, "/image/")), ")") : "url(".concat(__webpack_require__("./src/components/cards sync recursive ^.*\\/image\\/$")("".concat(test, "/image/")), ")")
    },
    onClick: cardToggle,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=server.fe96fda7485073cf546e.hot-update.js.map